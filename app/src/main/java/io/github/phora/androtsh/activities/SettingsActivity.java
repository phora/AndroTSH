...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected boolean isValidFragment(String fragName) {
        return GeneralPreferenceFragment.class.getName().equals(fragName) ||
                ServersFragment.class.getName().equals(fragName);
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            // bindPreferenceSummaryToValue(findPreference("isDark"));
        }
    }
}
